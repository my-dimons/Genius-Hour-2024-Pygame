...
def main():
    ...
    road_left = pygame.Rect(ROAD_LEFT, ROAD_START_POS, ROAD_LINES_HEIGHT, HEIGHT)
    road_right = pygame.Rect(ROAD_RIGHT, ROAD_START_POS, ROAD_LINES_HEIGHT, HEIGHT)
    gas_can_list = []
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if (current_fuel > 0):
                    ...
                    print(score)
            elif event.type == FUELEVENT: #SPAWN FUEL CAN
